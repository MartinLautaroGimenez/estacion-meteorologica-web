...
<body>
  ...
  <section class="home-section">
    ...
    <div class="sidebar-button">
      ...
      <a href="descargar.php" class="custom-btn">Descargar Excel</a>
    </div>
    </nav>
    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Humedad Relativa</div>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box" style="width: 100% !important;">
          <div class="title">Datos Recientes</div>
          <div class="sales-details">
            <ul class="details">
            <?php $tabla_datos = tabla_Datos(); echo $tabla_datos; ?>
          </div>
        </div>
      </div>
    </div>
