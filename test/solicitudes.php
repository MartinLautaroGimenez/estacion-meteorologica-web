    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">Solicitudes</span>
            </div>
            ...
            <div class="sales-boxes">
                <div class="recent-sales box" style="width: 100% !important;">
                    <div class="sales-details">
                        <ul class="details">
                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdCc5q0Fr36KnmMgWx13UDBOX22rMsCf615CEEkcwd_f_TF4g/viewform?embedded=true" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
                        </ul>
                    </div>
                </div>
            </div>
